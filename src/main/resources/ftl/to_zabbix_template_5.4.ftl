...
<#macro hostPrototype hp t>
                    ...
                    <#if (hp.customInterfaces?? &&  hp.customInterfaces == 'YES')>
                    <custom_interfaces>YES</custom_interfaces>
                    <#if (hp.interfaces?size > 0)>
                    <interfaces>
                        <#list hp.interfaces as interface>
                        <interface>
                            ${xml_wrap(interface.ip!'','ip','')}
                            ${xml_wrap(interface.port!'','port','')}
                        </interface>
                        </#list>
                    </interfaces>
                    </#if>
